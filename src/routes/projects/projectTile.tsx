...
const ProjectTile = ({ project, href }: Props) => {
	...
	return (
        <a href={href}>
            <div className="drop-shadow-2xl text-pink teal relative overflow-hidden transition duration-200 transform rounded shadow-lg hover:-translate-y-2 hover:shadow-2xl hover:opacity-90 bg-purple">
                <img
